...
moreNumbers = [85.0, 90.0, 95.0, 99.0]

// Array literal syntax
let differentNumbers = [97.5, 98.5, 92.0]

// Array concatenation is super convenient in Swift.
moreNumbers = differentNumbers + moreNumbers
...
// Dictionary literal
var animalGroupsDict = ["geese":"flock", "lions": "pride", "whales":"pod"]
