...
let bools = [false, false, false, false, false]
...
var myLiteralDictionary = ["Anchovies" : true, "Coconut" : true, "Cilantro":false, "Liver":false]
...
presidentialPetsDict["George H. W. Bush"] = nil
...
if let presidentialDogs = presidentialDogs["Barack Obama"]{
    print("Michele Obama walks \(presidentialDogs) every morning.")
}else {
    print("No dog available!")
}
//: ### Exercise 13
