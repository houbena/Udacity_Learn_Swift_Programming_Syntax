...
let yourSentence = "Something called \(nounArray[3]) is calling something called \(nounArray[index2])"
let yourSillySentence = "Another thing called \(nounArray[4]) is calling \(nounArray[index1])"
//: ### Exercise 2
...
let shoutString =  "HEY YA! " + didYouKnowString.uppercaseString
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
var number = howManyCharacters.characters.count
for character in howManyCharacters.characters {
    number++
}
...
if word.containsString("tuna"){ containsSubS = true}
//: ### Exercise 6
//: Write a program that deletes all occurrences of the word "like" in the following string.
let lottaLikes = "If like, you wanna learn Swift, like, you should build lots of small apps, cuz it's like, a good way to practice."
let wordToDelete = "like"
var result = lottaLikes.stringByReplacingOccurrencesOfString(wordToDelete, withString: "")
//: ### Exercise 7
// Example
...
var dic = dictionary.first

for d in dictionary{
    var newString = sillyMonkeyString.stringByReplacingOccurrencesOfString("monkey", withString: "")
}
//: ### Exercise 8
...
var pennies = numOfPennies%(dollars*100)
var sum = "$\(dollars).\(pennies)"
//desired output = "$5.67"
//: # Let or Var?
import UIKit
import Foundation
